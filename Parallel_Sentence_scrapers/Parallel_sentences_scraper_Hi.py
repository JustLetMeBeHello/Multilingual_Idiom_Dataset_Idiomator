...
# --------- Config ----------
SEED_PATH = "idioms_structured/seed_idioms_hi_cleaned.jsonl"
TMX_PATH  = "en-hi.tmx"
OUT_PATH  = "idioms_with_examples_hi.jsonl"
MAX_EXAMPLES = 10
# ---------------------------
...
for event, elem in ET.iterparse(TMX_PATH, events=("end",)):
    ...
    if hi_text:
        ...
        for end_pos, (idx, idiom) in A.iter(hi_text):
            ...
            if not is_boundary(hi_text, start_pos, end_pos + 1):
                continue
        ...
        for idx in matched_idxs:
            ...
            if remaining_needed[idiom] > 0:
                examples[idiom].append({"hi": hi_text, "en": en_text})
